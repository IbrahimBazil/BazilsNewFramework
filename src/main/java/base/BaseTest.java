...
public class BaseTest extends BasePage {
	...
	public void launchingUrl(String brand, String ValidationUrl) {
		...
		// String
		// listViewUrl=prop.getProperty("baseUrl")+prop.getProperty("listViewURL");
		// String
		// DetailPageURL=prop.getProperty("baseUrl")+prop.getProperty("DetailPageURL");
		// String logoutUrl= prop.getProperty("baseUrl")+prop.getProperty("logoutURL");
		// String newSignupUrl=
		// prop.getProperty("baseUrl")+prop.getProperty("newSignupURL");
